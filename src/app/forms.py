...
class StepPericiasForm(FlaskForm):
    ...
    acrobacia = IntegerField('Acrobacia', validators=[NumberRange(0, 4)], default=0)
    adestramento = IntegerField('Adestramento', validators=[NumberRange(0, 4)], default=0)
    artes = IntegerField('Artes', validators=[NumberRange(0, 4)], default=0)
    atletismo = IntegerField('Atletismo', validators=[NumberRange(0, 4)], default=0)
    ciencias = IntegerField('Ciências', validators=[NumberRange(0, 4)], default=0)
    crime = IntegerField('Crime', validators=[NumberRange(0, 4)], default=0)
    enganacao = IntegerField('Enganação', validators=[NumberRange(0, 4)], default=0)
    fortitude = IntegerField('Fortitude', validators=[NumberRange(0, 4)], default=0)
    furtividade = IntegerField('Furtividade', validators=[NumberRange(0, 4)], default=0)
    iniciativa = IntegerField('Iniciativa', validators=[NumberRange(0, 4)], default=0)
    intimidacao = IntegerField('Intimidação', validators=[NumberRange(0, 4)], default=0)
    intuicao = IntegerField('Intuição', validators=[NumberRange(0, 4)], default=0)
    investigacao = IntegerField('Investigação', validators=[NumberRange(0, 4)], default=0)
    luta = IntegerField('Luta', validators=[NumberRange(0, 4)], default=0)
    medicina = IntegerField('Medicina', validators=[NumberRange(0, 4)], default=0)
    oficio = IntegerField('Oficio', validators=[NumberRange(0, 4)], default=0)
    oficio_nome = IntegerField('oficio_nome', validators=[NumberRange(0, 4)], default=0)
    oficio_atributo = IntegerField('oficio_atributo', validators=[NumberRange(0, 4)], default=0)
    percepcao = IntegerField('Percepção', validators=[NumberRange(0, 4)], default=0)
    persuasao = IntegerField('Persuasão', validators=[NumberRange(0, 4)], default=0)
    pilotagem = IntegerField('Pilotagem', validators=[NumberRange(0, 4)], default=0)
    pontaria = IntegerField('Pontaria', validators=[NumberRange(0, 4)], default=0)
    profissao = IntegerField('Profissão', validators=[NumberRange(0, 4)], default=0)
    reflexos = IntegerField('Reflexos', validators=[NumberRange(0, 4)], default=0)
    religiao = IntegerField('Religião', validators=[NumberRange(0, 4)], default=0)
    sobrevivencia = IntegerField('Sobrevivência', validators=[NumberRange(0, 4)], default=0)
    tatica = IntegerField('Tática', validators=[NumberRange(0, 4)], default=0)
    tecnologia = IntegerField('Tecnologia', validators=[NumberRange(0, 4)], default=0)
    historia = IntegerField('História', validators=[NumberRange(0, 4)], default=0)
    vontade = IntegerField('Vontade', validators=[NumberRange(0, 4)], default=0)
